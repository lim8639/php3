            ...
            <ul >
                <li style="padding-top: 10px" >
                    ...
                    height: 38px;border: #FFFFFF" data-toggle="modal" data-target="#myModal">
                        ...
                        <span class="hidden-sm hidden-xs glyphicon glyphicon-search">Search</span>
                    </span>
                </li>
                ...
                <li style="padding-top: 10px" class="hidden-lg hidden-md"> <a href="user/user.php"><b><span style="font-size: 25px;vertical-align: center" class="glyphicon glyphicon-home"></span></b></a></li>
            </ul>
        </div>
    </div>
</header>
