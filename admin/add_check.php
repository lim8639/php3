    ...
    if(empty($content))
{
    echo "<script>alert('描述不能为空');history.back();</script>";
...

        {
            ...
            $sql="insert into tab_modity(modityname,warehouse,typename,bid,time,sellprice,picture,moditydescribe) value('$modityname',$warehouse,'$typename',$bid,'$time',$sellprice,'$photo','$content')";
