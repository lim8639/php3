...
var domUtils = (dom.domUtils = {
  ...
  /**
     ...
     *
     *     //output: false
     *     console.log( UE.dom.domUtils.isBlockElm( document.getElementById("php3") ) );
     *
     *     //output: true
  ...
  /**
     ...
     * @example
     * ```html
     * <span id="test" class="test1 php3 test3">xxx</span>
     *
     * <script>
     *
     *     var testNode = document.getElementById( "test" );
     *     UE.dom.domUtils.removeClasses( testNode, "test1 php3" );
     *
     *     //output: test3
  ...
  /**
     ...
     *
     *     var test1 = document.getElementById("test1"),
     *         php3 = document.getElementById("php3");
     *
     *     UE.dom.domUtils.moveChild( test1, php3 );
     *
     *     //output: ""（空字符串）
     *     console.log( test1.innerHTML );
     *
     *     //output: "<div></div><span></span>"
     *     console.log( php3.innerHTML );
     *
     * </script>
     * ```
     */
  ...
  /**
     ...
     *         php3 = document.getElementById("php3");
     *
     *     UE.dom.domUtils.moveChild( test1, php3, true );
     *
     *     //output: ""（空字符串）
     *     console.log( test1.innerHTML );
     *
